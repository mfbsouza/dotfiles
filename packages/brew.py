...
cliTui = ("git git-lfs tmux tree htop fastfetch neovim vim ripgrep fd fzf nanocom ")
coding = ("oven-sh/bun/bun gcc llvm zig go python virtualenv pyenv pyenv-virtualenv basedpyright node lua ")
