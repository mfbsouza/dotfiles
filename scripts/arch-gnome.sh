...
sdl2_image jdk8-openjdk jre8-openjdk firefox steam mpv transmission-gtk \
...
yay -S opencl-amd chrome-gnome-shell visual-studio-code-bin telegram-desktop-bin \
