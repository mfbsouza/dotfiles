...
mesa lib32-mesa intel-media-driver libvdpau-va-gl \
vulkan-icd-loader lib32-vulkan-icd-loader vulkan-intel lib32-vulkan-intel \
nvidia-utils lib32-nvidia-utils opencl-nvidia nvidia-settings nvidia-prime \
vulkan-tools mesa-demos clinfo libva-utils gnome dconf-editor gnome-tweaks \
xdg-desktop-portal xdg-desktop-portal-gtk power-profiles-daemon networkmanager-openvpn pipewire \
...
chromium telegram-desktop steam mpv transmission-gtk \
